...
<body>
    <div class="container">
        ...
        <p>
            <a href="https://github.com/elboletaire/password-strength-meter">Password Strength Meter</a> is a jQuery plugin that allows you to easily bind a progress bar showing the strength of a password to your inputs with multiple options.
        </p>
        <p>
        ...
        <form action="#">
            ...
            <fieldset>
                <legend>Linked to username input (password cannot contain username)</legend>
                <div class="form-group">
                    <label for="username">
                        Username
                    </label>
